...
public class Filter {
	...
	public static List<Tweet> inTimespan(List<Tweet> tweets, Timespan timespan) {
	    ...
	    for (Tweet tweet : tweets) {
	        ...
	        // Check if the tweet's timestamp falls within the timespan
	        if (tweetTime.equals(timespan.getStart()) || tweetTime.equals(timespan.getEnd())
	            || (tweetTime.isAfter(timespan.getStart()) && tweetTime.isBefore(timespan.getEnd()))) {
	            result.add(tweet);
	        }
	    }
	    return result;
